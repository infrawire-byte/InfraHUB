...
export default function ModuleListagem() {
  const permissions = usePermissions('infraestrutura');
  const { data, isLoading, isError } = useQuery(['infraestrutura', 'list'], () => moduleService.list());

  return (
    <div className="card">
      <header style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem' }}>
        <h2>Listagem de Infraestrutura</h2>
